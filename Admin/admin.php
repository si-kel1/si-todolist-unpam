...
<div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>Admin</h2>
                        <a href="admin_tambah.php" class="btn">Tambah Admin</a>
                    </div>
                ...
                include '../koneksi.php';
                $no=1;
                $data = mysqli_query($koneksi,"SELECT * FROM adminn");
                  ...
                  <tr>
                    ...
                    <td>
                      <center>
                        ...
                        <?php }else{ ?>
                          <img src="../gambar/user/<?php echo $d['admin_foto'] ?>" style="width: 80px;height: auto">
                        <?php } ?>
                      </center>
                    </td>
                    <td>                        
