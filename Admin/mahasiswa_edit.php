...
<body>
<div class="container"> 
<form id="contact" action="mahasiswa_update.php" method="post">
            ...
            <form action="mahasiswa_update.php" method="post" enctype="multipart/form-data">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" name="nama" value="<?php echo $d['nama_mahasiswa'] ?>" required="required">
                  <input type="hidden" class="form-control" name="id" value="<?php echo $d['mahasiswa_id'] ?>" required="required">
                </div>

                <div class="form-group">
                  <label>Username</label>
                  <input type="text" class="form-control" name="username" value="<?php echo $d['mahasiswa_username'] ?>" required="required">
                </div>
